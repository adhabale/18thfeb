...
@Input() disabledVal=false;
  ...
  ngOnInit() {
    ...
    this.createForm();
 this.onChanges();
    this.insuranceReinsuranceData.emit(this.insuranceReinsuranceGroup);
       }
  ...
  openDialog(item) {
    if (!item)
      item = null;
    this.dialog.open(TempComponentComponent, {
      width: '600px',
      height: '350px',
      data: item
    });
  ...
  // disabled(){
  //   if(this.disabledVal=true){
  //     this.insuranceReinsuranceGroup.disable();
  //   }
  //   else{
  //     this.insuranceReinsuranceGroup.enable(); 
  //   }
  ...
  uploadFile() {
    ...
    return this.insuranceReinsuranceGroup.get('sanctionedCountry')
  }
//14-2
  getSanctionedCountries(val){
 this.insuranceReinsuranceGroup.controls['questions'].value[3].answer=val;
  }

  isDisabled(){
    // if(this.formData.sanctionedCountry.length!=0){
    //   return this.formData.sanctionedCountry;
    // }
    // else{return [];}
  }
 bind(){
let fArray = this.insuranceReinsuranceGroup.controls['questions'].value[2].answer;
while(fArray.length !=0)
  {fArray.pop(0)}//reset array

   this.qThreeValue.forEach(element => {
 this.insuranceReinsuranceGroup.controls['questions'].value[2].answer.push(element.value);
});
 }
...
this.bind();
   ...
   qEightAnswer() {
    const c = this.insuranceReinsuranceGroup.controls['questions'].value[7].answer
    ...
    qNineAnswer() {
    const c = this.insuranceReinsuranceGroup.controls['questions'].value[8].answer
      if(c.boolean=='Yes'){return true}
   else{
     c.textarea=''
     return false
  ...
  qTenAnswer(val) {
  const c = this.insuranceReinsuranceGroup.controls['questions'].value[9].answer;
   if(c.boolean=='Yes'){return true}
   else{
     c.textarea=''
     return false
   ...
   createForm() {
    ...
    this.insuranceReinsuranceGroup = this._formBuilder.group({
      sanctionTypeId:'1',
      sanctionTypeName:'Insurance/Reinsurance',
