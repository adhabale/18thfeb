...
import { SanctionActivityTypeComponent } from './modules/create-sanction-request/sanction-activity-type/sanction-activity-type.component';
import { SanctionTypeComponent } from './modules/create-sanction-request/sanction-type/sanction-type.component';
import { TempComponentComponent } from './temp-component/temp-component.component';
import { SanctionReviewComponent } from './modules/create-sanction-request/sanction-review/sanction-review.component'
...
@NgModule({
  declarations: [
    ...
    SanctionActivityTypeComponent,

    SanctionTypeComponent,

    TempComponentComponent,

    SanctionReviewComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
  ...
  entryComponents: [TempComponentComponent,CommentTemplateComponent, DelegateAssignmentDialogComponent, AdduserComponent, EditBuComponent, EditInsuranceTypeComponent, EditLegalEntityComponent, UploadDocComponent],
  providers: [],
